...
<div class="login-box">
  ...
  <div class="card card-outline card-warning">
    ...
    <div class="card-body">
      ...
      <p class="login-box-msg">Verification code (input the sent code from your email)</p>

       <form action="<?php echo site_url('user/send_verify1/'.$data->identifier);?>" method="post">
        <div class="input-group mb-3">
          <input type="text" name="code" class="form-control" placeholder="Verification Code" required>
          <input type="hidden" name="email" value="<?php echo $data->email; ?>" class="form-control" required>
        </div>
        <div class="row">
          <div class="col-8">
      ...
      <p class="mb-1">
        <a href="<?php echo site_url('user/forgot1/');?>" style="color: grey;">Send another code</a>
      </p>
    </div>
    <!-- /.card-body -->
  </div>
