    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo site_url('user/db_report');?>" class="nav-link active">
...
<script>
  $(document).ready(function () {
    var t = $("#example1").DataTable({
      ...
      "buttons": [{extend: "copy", footer: true, exportOptions: {columns: ':visible'}}, 
                  ...
                  {extend: "colvis", footer: true, exportOptions: {columns: ':visible'}}],
          footerCallback: function (row, data, start, end, display) {
            ...
            // Update footer
            $(api.column(5).footer()).html(pageTotal + ' (' + total + ' overall total)');
            $(api.column(6).footer()).html(pageTotal1 + ' (' + total1 + ' overall total)');
        },
    ...
    t.on('order.dt search.dt', function () {
     t.column(0, {search:'applied', order:'applied'}).nodes().each( function (cell, i) {
      ...
      "responsive": true, "lengthChange": false, "autoWidth": true, "order": [[1, 'desc']],
      "buttons": [{extend: "copy", footer: true, exportOptions: {columns: ':visible'}}, 
                  {extend: "csv", footer: true, exportOptions: {columns: ':visible'}}, 
                  {extend: "excel", footer: true, exportOptions: {columns: ':visible'}}, 
                  {extend: "pdf", footer: true, exportOptions: {columns: ':visible'}}, 
      ...
      footerCallback: function (row, data, start, end, display) {
            ...
            // Update footer
            $(api.column(6).footer()).html(pageTotal + ' (' + total + ' overall total)');
        },
      initComplete: function () {
            this.api().columns([]).every( function () {
                var column = this;
